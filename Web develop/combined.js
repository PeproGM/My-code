document.addEventListener("DOMContentLoaded", () => {
    ...
    const singleInputHTML = `
      <div class="input-inner">
        ...
        <div class="panel-actions" style="display: flex; gap: 10px; margin-top: 15px;">
          <button id="singleConfirmBtn" type="button" style="flex: 1; padding: 12px; background: var(--accent); color: #fff; border: none; border-radius: 8px; cursor: pointer; font-weight: bold;">Додати</button>
          <button id="singleCancelBtn" type="button" style="flex: 1; padding: 12px; background: #666; color: #fff; border: none; border-radius: 8px; cursor: pointer; font-weight: bold;">Повернутися</button>
        </div>
      </div>
    `;
  ...
  /* Подключи сюда свой вызов при подтверждении транзакции */
